        ...
        <div class="bg-white border border-slate-300 rounded-xl w-full p-3">
            <form action="{{ route('storeStudentRegistration') }}" method="post">
                ...
                <table class="rounded-xl px-4 w-full">
                    <tbody>
                        <tr>
                            ...
                            <td class="px-4 py-2"><input type="text" name="student_name"
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2"><input type="number" name="student_age"
                                    class="form-control rounded-xl w-full bg-gray-200 border border-slate-400" required>
                            </td>
                        </tr>
                        <tr></tr>
                        <td class="px-4 py-2"><label>Student Gender</label></td>
                        <td class="px-4 py-2"><select name="student_gender" id="student_gender" required
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2"><input type="text" name="student_birthRegNo"
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2"><input type="text" name="student_ic"
                                    class="form-control rounded-xl w-full bg-gray-200 border border-slate-400" required>
                            </td>
                        </tr>
                        <tr>
                            <td class="px-4 py-2"><label>Student Health</label></td>
                            <td class="px-4 py-2"><input type="text" name="student_health"
                                    class="form-control rounded-xl w-full bg-gray-200 border border-slate-400" required>
                            </td>
                        </tr>
                        <tr>
                            <td class="px-4 py-2"><label>Student Birth Place</label></td>
                            <td class="px-4 py-2"><input type="text" name="student_birthPlace"
                                    class="form-control rounded-xl w-full bg-gray-200 border border-slate-400" required>
                            </td>
                        </tr>
                        <tr>
                            <td class="px-4 py-2"><label>Student Home Address</label></td>
                            <td class="px-4 py-2"><input type="text" name="student_homeAddress"
                                    class="form-control rounded-xl w-full bg-gray-200 border border-slate-400" required>
                            </td>
                        </tr>
                    </tbody>
                ...
                <div class="flex justify-end px-4 py-2">
                    ...
                    <div class="px-4">
                        <button class="btn border border-slate-400 bg-gray-400 px-3 py-2 rounded-xl hover:bg-gray-300"
                            formaction="{{route('ManageStudentRegistration.StudentRegistrationList')}}">Cancel</button>
                    </div>
                </div>
            </form>
        </div>
